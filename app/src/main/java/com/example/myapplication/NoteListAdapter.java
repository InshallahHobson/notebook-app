...
public class NoteListAdapter extends RecyclerView.Adapter<NoteListAdapter.WordViewHolder> {
    ...
    class WordViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
         ...
         */
        public WordViewHolder(View itemView, NoteListAdapter adapter) {
            super(itemView);
            wordItemView = (TextView) itemView.findViewById(R.id.goToNote);
    ...
    public NoteListAdapter(Context context, LinkedList<String> wordList) {
